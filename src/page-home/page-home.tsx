      ...
      render() {
          return [
            <div class="scoreboard">
                ...
                {!this.isLoggedIn && <button onClick={() => this.signInWithGoogle()}>
                    Login with Google
                </button>}

                <form>
                <input ref={(el) => this.emailInputEl = el} type="email" name="email" placeholder="Email Address" />
                <input ref={(el) => this.passwordInputEl = el} type="password" name="password" placeholder="Password" />
